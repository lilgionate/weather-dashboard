...
const API_KEY = "167d054ad32980141fdd579490d9c057"; // API key for OpenWeatherMap API
...
const createWeatherCard = (cityName, weatherItem, index) => {
    if(index === 0) { // HTML for the main weather card
      return `<div class="details">
            ...
            <div class="icon">
            <img src="https://openweathermap.org/img/wn/${weatherItem.weather.split[0].icon}@4x.png" alt="weather-icon">
            <h4>${weatherItem.weather[0].description}</h4>
            </div>`;
    } else {
    return `<li class="card">
            <h3>(${weatherItem.dt_txt.split(" ")[0]})</h3>
            <img src="https://openweathermap.org/img/wn/${weatherItem.weather.split[0].icon}@2x.png" alt="weather-icon">
...
const getUserCordinates = () => {
    navigator.geolocation.getCurrentPosition(
        position => {
            ...
            const REVERSE_GEOCODING_URL = `http://api.openweathermap.org/geo/1.0/reverse?lat=${latitude}&lon=${longtitude}&limit=1&appid=${API_KEY}`;
